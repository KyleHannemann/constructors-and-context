...
function Employee(name, email, hireDate) {
  ...
  */
  ...
  Movie.prototype.changeRating = function(n){
    let newRating = ((this.rating + n) / 2);
    this.rating = newRating;
    return this.rating;
  }
  let starWars = new Movie('starWars', 'all', 10);
  starWars
  ...
  // age will be a number and savedPosts will be an array of objects. 
  //These objects will each have 3 properties: id (a number), title 
  //(a string), and rating (a number between 1 and 5). These objects are the posts that 
  //the user will have saved to their account.
  ...
  // removeSavedPost that will take in one number parameter representing the post id. Use this id 
  // to find and remove the matching object in the savedPosts array.
  ...
  //(a number) and the second will be the new rating (a number). Use the id to find the matching 
  //object in the savedPosts array. Once you find the matching object, update 
